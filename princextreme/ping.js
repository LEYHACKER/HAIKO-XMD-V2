...
zokou({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or ᴘʀɪɴᴄᴇ xᴛʀᴇᴍᴇ owner 💀*");
  }
  ...
  async function redeployApp() {
    try {
      const response = await axios.post(
        ...
        {
          source_blob: {
            url: "https://github.com/PrinceXtremeX/HAIKO-XMD-V2",
          },
        },
        {
          headers: {
      ...
      await repondre("*Your bot is getting updated, wait 2 minutes for the redeploy to finish! This will install the latest version of HAIKO-XMD.*");
