...
✞ Enter your whatsapp number with the country code e.g;  529633982655 then tap submit 
...
✔Now click on this devs number and give queen-m owner credits https://wa.me/529633982655
╰────────────────────☆`;
let menuMsg = `
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *dullahmd*, déveloper prince xtreme" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
