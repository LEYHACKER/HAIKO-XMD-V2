...
zokou({
  ...
  await _0xb269b7("*HAIKO XMD is sending this message to all groups you are in*...");
...
zokou({
  ...
  try {
    ...
    for (let _0x269fcd of _0x267c2d) {
      ...
      let _0x5838c2 = _0x269fcd.name || _0x269fcd.notify || "[PRINCE X] +" + _0x23a8f8;
